...
<html lang="en">
  ...
  <body id="page-top">
	...
	String connectionURL = "jdbc:mysql://localhost:3306/topupit";
            ...
            ResultSet rs=stmt.executeQuery("SELECT `uni_id`,`uni_name` FROM `uni_admission` INNER JOIN uni_det ON uni_det_uni_det_id=uni_det_id WHERE `category_idcategory`=1 ");
            //String id="";
            //pw.print("hi");
            while(rs.next()){
            	%>
